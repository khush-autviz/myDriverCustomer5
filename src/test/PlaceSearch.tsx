...
//     // revert to selected value if user tries to type manually
//     if (timeoutRef.current) clearTimeout(timeoutRef.current);
//     timeoutRef.current = setTimeout(() => {
//       if (text !== selectedDescription) {
//         setQuery(selectedDescription);
//       }
//     }, 800); // wait 800ms to allow paste then revert
  ...
  return (
    <View style={styles.container}>
      <TextInput
        ...
        onChangeText={handleChangeText}
        onFocus={setActive}
        onBlur={handleBlur} // Set blur handler here
      />
